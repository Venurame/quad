...
airflow roles add-perms NView --action 'can_edit' --resource 'My Password' 'My Profile' 'DAG Runs' 'Task Instances' 'DAGs'
airflow roles add-perms NView --action 'can_delete' --resource 'DAG Runs' 'Task Instances' 'DAGs'
